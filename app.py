...
with right:
    ...
    if st.session_state.started and not st.session_state.finished:
        ...
        st.session_state.started   = False   # ← key: flip started OFF so left panel shows download buttons

        # Force a rerun NOW so the download buttons render in the left panel
        st.rerun()
